...
public:
	...
	DeckOfCards()//initialzing a full deck of cards
	{
		for(int s = 0; s < 4; s++){
			for(int f = 0; f < 13; f++){
	...
	void shuffle()//shuffling deck by randomly going through a for loop,
	...
	Card dealCard()//a function that returns the last element of the vector
